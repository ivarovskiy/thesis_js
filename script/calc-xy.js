...
/*Скрывает исходно блоки для различных этапов обработки растрових изображений осциллограмм, кроме блока с исходной информацией*/
$("#begin").show();
$("#cmt").hide();
$("#numb").hide();
$("#tau").hide();
...
//Присваивает количестиу сканированных точек k и индексу элементов массива i начальные значения
k=1;i=0;
//Очищает поля форм количесива точек сканирования и результатова измерения
...
$("#din").hide();//Скрывает инструкцию о возможности повторных измерений на последнем этапе обрпботки
});

/*При нажатии на кнопку "Начать обработку" открывает панель для определения масштаба растрового изображения"*/
$("#work").click(function(){
$("#begin").hide();
$("#cmt").show();$("#kto").focus();
});
...
$("#pro").click(function(){
if(z==0){$("#numb").hide();$("#cmt").show(); $("#Uzero").hide();$("#tau").hide();document.getElementById("kto").focus()};
if(z==1){$("#numb").hide();$("#cmt").hide(); $("#Uzero").show();$("#tau").hide()};
if(z==2){$("#numb").show();$("#cmt").hide(); $("#Uzero").hide();$("#tau").hide();document.getElementById("nn").focus();};
if(z==3){$("#numb").hide();$("#cmt").hide(); $("#Uzero").hide();$("#tau").show()}
for(var m=i;m>=0;m--)
{
$(".dat:last").remove();
T[m]=undefined;U[m]=undefined;
